...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">التعليقات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل تعليق</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<form action="{{ route('comment.update', $comment->id) }}" method="post" autocomplete="off">
									...
									<div class="row">
										<div class="col">
											<label for="inputName" class="control-label">التعليق</label>
									...
									{{-- <div class="row">
										<div class="col">
											...
											value="{{ $comment->slug }}" required>
										</div>
									</div><br> --}}

									<div class="form-group">
										<label class="display-block">حالة التعليق</label> <br>
