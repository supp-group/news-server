					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<form action={{ route('categoryc.save') }} method="post" enctype="multipart/form-data" autocomplete="off">
									{{ csrf_field() }}
									...
									<div class="row">
										<div class="col">
											<label for="exampleTextarea">صورة التصنيف</label>
											<input type="file" name="category_image" class="dropify" accept=".jpg, .png, image/jpeg, image/png"
											data-height="70" />
										</div>
									</div><br>
