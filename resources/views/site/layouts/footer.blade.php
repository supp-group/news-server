<footer class="bg-dark mt-5">
      ...
      <div class="row">
        <div class="col-lg-10 mx-auto text-center">
          <a class="d-inline-block mb-4 pb-2" href="index.html">
            <img loading="prelaod" decoding="async" class="img-fluid" src={{ URL::asset('theme/images/logo-white.png') }} alt="Reporter Hugo">
          </a>
    ...
    <div class="copyright bg-dark content">Designed &amp; Developed By <a href={{ URL::asset('https://themefisher.com/') }}>Themefisher</a></div>
</footer>